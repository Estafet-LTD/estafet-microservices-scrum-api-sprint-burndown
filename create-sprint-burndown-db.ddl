...
create table SPRINT (SPRINT_ID int4 not null, NO_DAYS int4 not null, SPRINT_NUMBER int4 not null, START_DATE varchar(255) not null, primary key (SPRINT_ID));
create table SPRINT_DAY (SPRINT_DAY_ID int4 not null, DAY_NO int4 not null, HOURS_TOTAL int4 not null, SPRINT_DAY varchar(255) not null, SPRINT_ID int4 not null, primary key (SPRINT_DAY_ID));
