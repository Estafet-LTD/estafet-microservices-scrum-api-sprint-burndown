...
node("maven") {
	...
	stage("checkout") {
		git branch: "master", url: "https://github.com/${params.GITHUB}/estafet-microservices-scrum-api-sprint-burndown"
	}
	...
	stage("execute the container tests") {
			withEnv(
				[	"SPRINT_BURNDOWN_JDBC_URL=jdbc:postgresql://postgresql.${project}.svc:5432/${project}-${microservice}", 
